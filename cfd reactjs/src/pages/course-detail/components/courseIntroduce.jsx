...
const CourseIntroduced = ({describe}) => {
    return (
        <section className="section-2">
            <div className="container">
                ...
                <Accordion date='1' title='Giới thiệu HTML, SEO, BEM.' content={'I\'d like to demonstrate a powerful little pattern called '
                    + '“Server-Fetched Partials” that offers some tangible benefits over alternatives like VueJS for simple page interactions.'} />
                <Accordion date='2' title='CSS, CSS3, Flexbox, Grid.' content={'I\'d like to demonstrate a powerful little pattern called '
                    + '“Server-Fetched Partials” that offers some tangible benefits over alternatives like VueJS for simple page interactions.'} />
                <Accordion date='3' title='Media Queries.' content={'I\'d like to demonstrate a powerful little pattern called '
                    + '“Server-Fetched Partials” that offers some tangible benefits over alternatives like VueJS for simple page interactions.'} />
                <Accordion date='4' title='Boostrap 4.' content={'I\'d like to demonstrate a powerful little pattern called '
                    + '“Server-Fetched Partials” that offers some tangible benefits over alternatives like VueJS for simple page interactions.'} />
                <Accordion date='5' title='Thực hành dự án website Landing Page.' content={'I\'d like to demonstrate a powerful little pattern called '
                    + '“Server-Fetched Partials” that offers some tangible benefits over alternatives like VueJS for simple page interactions.'} />
                <Accordion date='6' title='Cài đặt Grunt và cấu trúc thư mục dự án.' content={'I\'d like to demonstrate a powerful little pattern called '
                    + '“Server-Fetched Partials” that offers some tangible benefits over alternatives like VueJS for simple page interactions.'} />
